...
function [SSE,Corr,Corr_nonzero,A_vec_non,B_vec_non] = EstimationJacobianPlotting(A,B)
...
figure(1)
scatter(A_vec,B_vec,'MarkerEdgeColor',[155/256,190/256,219/256],...
...
hold off
set(gca,'box','off');
% title(['r_J=', num2str(Corr), '***']);
xlabel('Ground Truth Jacobian');
ylabel('Estimated Jacobian');
xticks([0 7]);
yticks([0 7]);
alpha(0.8);
saveas(gcf,'JacobianPerformance.png');
...
figure(2)
scatter(A_vec_non,B_vec_non,'MarkerEdgeColor',[155/256,190/256,219/256],...
        'MarkerFaceColor',[155/256,190/256,219/256]);
...
hold off
set(gca,'box','off');
% title('Estimated Jacobian against Analytical Jacobian (Non zero)');
xlabel('Ground Truth Jacobian');
ylabel('Estimated Jacobian');
xticks([0 7]);
yticks([0 7]);
alpha(0.8);
saveas(gcf,'NonZeroJacobianPerformance.png');
